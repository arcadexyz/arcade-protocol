...
////// MAINNET ADDRESSES //////
///////////////////////////////
export const BORROWER = "0x148216a1800ab3d71668b4126b4244a9a909955f"; // user calling the rollover function
...
export const LOAN_ID = 2225; // active v2 loanId on mainnet
export const COLLATERAL_ID = BigNumber.from("1208286525409893052631029571811051579906857416669"); // vault id on mainnet
export const V2_TOTAL_REPAYMENT_AMOUNT = ethers.utils.parseUnits("7.174", 18); // old repayment amount with interest amount included

///////////////////////////////
//////// V3 LOAN DATA /////////
///////////////////////////////
export const NONCE = 1; // nonce to use in new lender's bid
export const V3_LOAN_PRINCIPAL = ethers.utils.parseUnits("7.0", 18); // new loan principal
