    ...
    AccessControlEnumerable
{
    ...
    function initializeLoan(
        ...
        {
            // Determine if the borrower callback should be executed.
            // Do not allow lender to execute arbitrary callback data.
            bool executeCallback = (
                neededSide == Side.LEND ||
                borrowerData.borrower == externalSigner ||
                isApproved(borrowerData.borrower, externalSigner)
            ) && borrowerData.callbackData.length > 0;
     ...
     * @param borrowerData                  Struct containing borrower address and any callback data.
     * @param lender                        Address of the lender.
     * @param executeCallback               Whether the borrower callback should be executed.
     *
     * @return loanId                       The unique ID of the new loan.
     */
    function _initialize(
        ...
        // If appropriate, call the callback function on the borrower
        if (executeCallback) {
