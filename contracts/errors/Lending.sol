...
// ================================== ORIGINATION CONTROLLER CURRENCY MIGRATE ====================================
/// @notice All errors prefixed with OCCM_, to separate from other contracts in the protocol.
 ...
 * @param lendingPool             Expected address of the flash loan provider.
 */
error OCCM_UnknownCaller(address caller, address lendingPool);

/**
 * @notice Only the holder of the borrowerNote can rollover their loan.
 */
error OCCM_CallerNotBorrower();
 ...
 * @notice The rollover contract is already in the specified pause state.
 */
error OCCM_StateAlreadySet();

/**
 * @notice Borrower address is not cached of the flash loan callback.
 */
error OCCM_BorrowerNotCached();
 ...
 * @param cachedBorrower          Borrower address saved in the rollover contract.
 */
error OCCM_UnknownBorrower(address providedBorrower, address cachedBorrower);
 ...
 * @param borrower                The borrower address.
 */
error OCCM_BorrowerNotReset(address borrower);
 ...
 * @param state                   Current state of a loan according to LoanState enum.
 */
error OCCM_InvalidState(uint8 state);
 ...
 * @param signer                       The address of the external signer.
 */
error OCCM_SideMismatch(address signer);
 ...
 * @param newCurrency                   The currency of the new loan.
 */
error OCCM_CurrencyMatch(address oldCurrency, address newCurrency);
