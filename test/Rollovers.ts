...
const fixture = async (): Promise<TestContext> => {
    ...
    await feeController.setLendingFee(await feeController.FL_04(), 10);
...
describe("Rollovers", () => {
    ...
    describe("Rollover Fees", () => {
        it("should rollover to the same lender, with the borrower paying no fee", async () => {
            ...
            await feeController.setLendingFee(await feeController.FL_04(), 0);
        ...
        it("should rollover to the same lender, with the lender paying a 1% fee", async () => {
            ...
            await feeController.setLendingFee(await feeController.FL_04(), 0);
            await feeController.setLendingFee(await feeController.FL_05(), 1_00);
