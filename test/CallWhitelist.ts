...
describe("CallWhitelist", () => {
    ...
    describe("Whitelist", function () {
        ...
        it("adding twice is a noop", async () => {
            ...
            await expect(whitelist.add(mockERC20.address, selector)).to.be.revertedWith(
                `CW_AlreadyWhitelisted("${mockERC20.address}", "${selector}")`,
            );
        });
        ...
        it("removing twice is a noop", async () => {
            ...
            await expect(whitelist.remove(mockERC20.address, selector)).to.be.revertedWith(
                `CW_NotWhitelisted("${mockERC20.address}", "${selector}")`,
            );
        });
